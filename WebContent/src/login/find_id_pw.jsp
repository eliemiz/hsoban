...
<br><br>
<h5 align="center">아이디 찾기</h5><hr width="900"><br>
<pre align="center">회원가입 시, 입력하신 이름 + 이메일 또는 휴대폰 번호로 아이디를 확인하실 수 있습니다.
	...
	<form id="form1">
		<table border>
			...
			<tr><th>&nbsp;&nbsp;이메일</th><td><input type="text" name="mail" ></td></tr></table><br>
	...
	<form id="form2">
		<table border>
			<tr><th>&nbsp;&nbsp;이&nbsp;름</th><td><input type="text" name="username"></td></tr>
			<tr><th>&nbsp;&nbsp;휴대폰 번호</th><td><input type="text" name="phone" ></td></tr></table><br>
			<div style="text-align:center;"><a href="find_id_fin.jsp"><span>
			<input type="button" class="btn btn_color" value="아이디찾기" style="height:30px; width:160px;"></span></a>
			<a href="login.jsp"><span>
			<input type="button" class="btn btn_black" value="로그인" style="height:30px; width:160px;"></span></a></div>
	</form><br><br>
<h5 align="center">비밀번호 찾기</h5><hr width="900"><br>
